...
@section('style')
{{ asset('styles/application_ok.css') }}
@stop
@section('navigation')
  @include('nav')
@stop
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="record-panel"><img src="/img/avatar.jpg" class="record-image image">
              <div class="record-time">00:05:01</div><a href="{{url('/video')}}" class="link">RECORD</a>
            </div>
